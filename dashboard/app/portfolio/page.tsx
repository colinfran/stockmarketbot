              ...
              <tbody>
                {calculations.positions.map((position) => (
                  ...
                  >
                    ...
                    <td
                      className={`text-right py-3 px-4 font-medium ${position.profitLoss >= 0 ? "text-green-500" : "text-red-500"}`}
                    >
                      {position.profitLoss >= 0 ? "+" : ""}${position.profitLoss.toFixed(2)}
                    </td>
                    <td
                      className={`text-right py-3 px-4 font-medium ${position.profitLossPercent >= 0 ? "text-green-500" : "text-red-500"}`}
                    >
